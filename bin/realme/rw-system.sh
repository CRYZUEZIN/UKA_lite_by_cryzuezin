...
mount -o bind /system/cryzuezin/vo /vendor/overlay || true
mount -o bind /mnt/phh/empty /vendor/apex || true
mount -o bind /system/cryzuezin/group /vendor/etc/group || true
mount -o bind /system/cryzuezin/passwd /vendor/etc/passwd || true
