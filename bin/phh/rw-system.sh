...
mount -o bind /system/ornament/vo /vendor/overlay || true
mount -o bind /mnt/phh/empty /vendor/apex || true
mount -o bind /system/ornament/group /vendor/etc/group || true
mount -o bind /system/ornament/passwd /vendor/etc/passwd || true
